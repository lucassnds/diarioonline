            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li id="modulo">
                      ...
                      <li id="titu">
                        <a href="?pagina=titu"><i class="glyphicon glyphicon-align-justify"></i> Titulações</a>
                    </li>
                     <li id="ponto">
                        <a href="?pagina=ponto"><i class="glyphicon glyphicon-file"></i> Pontos</a>
                    </li>
                    <li id="sub">
                        <a href="?pagina=substituicao"><i class="glyphicon glyphicon-refresh"></i> Substituições</a>
                    </li>
                    <li id="coor">
                        <a href="?pagina=coor"><i class="glyphicon glyphicon-menu-hamburger"></i> Coordenador</a>
                    </li>
                    <li id="admin">
                        <a href="?pagina=adms"><i class="glyphicon glyphicon-cog"></i> Administradores</a>
                    </li>
